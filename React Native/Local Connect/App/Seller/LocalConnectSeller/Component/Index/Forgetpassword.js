    ...
    return (
        ...
        <View style={styles.flexcolumn}>
                   ...
                   <View style={styles.flexcolumn}>
                       ...
                       <TouchableOpacity>
                           <TextInput placeholder="Email Address" style={styles.labelPassword}></TextInput>
                       </TouchableOpacity>
                   ...
                   <Text style={{ color: "#d50021", fontWeight: "bold", }} onPress={() => props.navigation.navigate("Login")}>Sign in</Text>
